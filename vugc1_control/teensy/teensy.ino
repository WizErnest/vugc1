...
#include <vugc1_control/drive_values.h>
#include <ros.h>
...
vugc1_control::drive_values previous;

void messageDrive(const vugc1_control::drive_values &pwm);
void messageEmergencyStop(const std_msgs::Bool &flag);

// ROS
ros::NodeHandle nh;
ros::Subscriber<vugc1_control::drive_values> control_serial_drive_parameters("vugc1_control_serial_drive_parameters", &messageDrive);
ros::Subscriber<std_msgs::Bool> control_emergency_stop("vugc1_control_emergency_stop", &messageEmergencyStop);
